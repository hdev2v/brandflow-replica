      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-2 lg:order-1 z-10">
            <h2 ref={titleRef} className="text-2xl md:text-3xl font-display font-semibold mb-3 text-pink-500">
              Hej jag heter Nadia!
            </h2>
            
            <h1 ref={subtitleRef} className="text-4xl md:text-5xl lg:text-6xl font-display font-bold tracking-tight mb-6">
              Jag hjälper dig växa med sociala medier
            </h1>
            
            <p ref={descriptionRef} className="text-lg md:text-xl text-gray-300 mb-8 max-w-xl">
            ...
            <div className="relative h-[540px] w-full">
              ...
              <div className="absolute right-0 top-0 w-[45%] h-[40%] z-10 transform translate-x-6 -translate-y-6">
                <div className="rounded-xl overflow-hidden shadow-lg h-full">
                  <img src="/lovable-uploads/2c1feb13-1205-4fcc-8e1d-371a4ec9929f.png" alt="Services Collage" className="w-full h-full object-cover object-center" />
                </div>
              </div>
              ...
              <div className="absolute right-0 bottom-0 w-[45%] h-[40%] z-10 transform translate-x-6 translate-y-6">
                <div className="rounded-xl overflow-hidden shadow-lg h-full">
                  <img src="/lovable-uploads/5489e3ba-6f97-4712-9cc6-b0075c0b0340.png" alt="Social Media Performance" className="w-full h-full object-cover object-center" />
                </div>
              </div>
